$(function() {
  ...
  if ($('#apexBar').length) {
    var options = {
      ...
      series: [{
        name: 'sales',
        data: [30,40,45,50,49,60,70,91,150]
      }],
      xaxis: {
        type: 'month',
        categories: ['January', 'February', 'March', 'April', 'June', 'July', 'August', 'Septembar', 'October', 'November', 'December'],
        axisBorder: {
          color: colors.gridBorder,
        },
        axisTicks: {
 ...
 // Apex Bar chart start
  if ($('#apexBar1').length) {
    var options = {
      ...
      series: [{
        name: 'Payment sales',
        data: [40,30,55,60,51,54,78,80,160]
      }],
      xaxis: {
        type: 'month',
        categories: ['January', 'February', 'March', 'April', 'June', 'July', 'August', 'Septembar', 'October', 'November', 'December'],
