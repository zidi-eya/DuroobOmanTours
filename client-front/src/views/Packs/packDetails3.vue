<template>
  ...
  <section
    ...
    style="background-image: url(/assets/images/destination/destination9.jpg)"
  >
    <div
  ...
  <section class="trending pb-0 bg-lgrey">
    <div class="container">
      <div class="row">
        <div>
          <div class="single-content">
            <div id="highlight" class="mb-4">
              ...
              <div class="description-images mb-4">
                <img
                  src="/assets/images/pack/pack4.jpeg"
                  alt=""
...
.gallery-image {
  width: 100%;
  height: 250px; /* choisis la hauteur que tu veux */
  overflow: hidden;
...
.gallery-image img {
  width: 100%;
  height: 100%;
  object-fit: cover; /* garde le bon ratio et remplit le cadre */
  display: block;
  border-radius: 10px;
}
</style>
